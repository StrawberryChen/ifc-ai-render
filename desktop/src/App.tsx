...
export default function App() {
  ...
  useEffect(() => {
    ...
    preloadModel(`${API}${project.staged_model_url}?v=${revisions[0]?.number ?? 0}&material=3`);
  }, [project, revisions]);
  useEffect(() => {
    ...
    <section className="workspace">
      <div className="stage-panel">
        ...
        <div className="viewport">
          {project && <ModelViewer hidden={tab === "render"} modelUrl={`${API}${viewerTab === "source" ? project.source_model_url : project.staged_model_url}${viewerTab === "staged" ? `?v=${stagedVersion}&material=3` : ""}`} staged={viewerTab === "staged"} onViewChange={viewerTab === "staged" ? setCameraView : undefined} />}
